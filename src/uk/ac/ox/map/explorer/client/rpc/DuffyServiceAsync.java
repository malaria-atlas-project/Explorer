...
public interface DuffyServiceAsync {

	void search(Integer firstResult, Integer maxResults, String searchParams,AsyncCallback<ArrayList<CountryAllProxy>> callback);
