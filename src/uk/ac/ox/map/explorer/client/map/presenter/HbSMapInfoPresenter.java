...
public class HbSMapInfoPresenter extends BaseMapInfoPresenter {
	  
	  private Boolean availableProxy = true;
	  private Boolean unavailableProxy = true;
	  private final String AVAILABLE_LAYER = "Explorer:hbs_data_available";
	  private final String UNAVAILABLE_LAYER = "Explorer:hbs_data_unavailable";
	  
	  @Inject
	  public HbSMapInfoPresenter(MapInfoView mapInfoView,
	  ...
	  public void updateMapInfo(Bounds bounds) {
	    ...
	    rpcService.getHbSExtentInfo(availableProxy, unavailableProxy,
