...
import uk.ac.ox.map.explorer.client.rpc.PvPRService;
...
public class PvPRServiceImpl extends RemoteServiceServlet implements PvPRService {
	
	private Provider<SimpleDao> daoProvider;

	@Inject
	public PvPRServiceImpl(Provider<SimpleDao> dao) {
		daoProvider = dao;
	}
