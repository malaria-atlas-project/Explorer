...
public class HbSSelectedEvent extends GwtEvent<HbSSelectedEvent.Handler> {

	public interface Handler extends EventHandler {
		void onCountrySelected(HbSSelectedEvent requestEvent);
	}
	...
	public static HandlerRegistration register(EventBus eventBus,
			HbSSelectedEvent.Handler handler) {
		return eventBus.addHandler(TYPE, handler);
	}

	private CountryAllProxy country;

	public HbSSelectedEvent(CountryAllProxy Country) {
		country = Country;
	}
