...
public class PvPRMapInfoPresenter extends BaseMapInfoPresenter {
	
	private Boolean availableProxy = true;
	  private Boolean unavailableProxy = true;
	  private final String AVAILABLE_LAYER = "Explorer:pvpr_display_available";
	  private final String UNAVAILABLE_LAYER = "Explorer:pvpr_display_unavailable";
	  
	  @Inject
	  public PvPRMapInfoPresenter(MapInfoView mapInfoView,
	  ...
	  public void updateMapInfo(Bounds bounds) {
	    ...
	    rpcService.getPvPRExtentInfo(availableProxy, unavailableProxy,
