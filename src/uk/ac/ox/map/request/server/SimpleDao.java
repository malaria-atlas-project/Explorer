...
public class SimpleDao {
  ...
  public <T> List<T> search(Integer firstResult, Integer maxResults,
      String searchParam, Class<T> clazz) {
    ...
    if (ep.isNamedQuery()) {
      ...
      tq = em.createQuery(cq).setFirstResult(firstResult)
  ...
  public Long searchCount(String searchParams, Class<?> clazz) {
    ...
    CriteriaBuilder cb = em.getCriteriaBuilder();
    CriteriaQuery<Long> cq = CriteriaQueryBuilder.getCountQuery(clazz,
        PlaceUtils.getMapFromParams(searchParams), cb);
