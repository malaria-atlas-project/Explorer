...
import uk.ac.ox.map.explorer.client.rpc.HbSService;
...
public class HbSServiceImpl extends RemoteServiceServlet implements
		HbSService {

	private Provider<SimpleDao> daoProvider;

	@Inject
	public HbSServiceImpl(Provider<SimpleDao> dao) {
		daoProvider = dao;
	}
