 ...
 * clients.
 * 
 * Subclasses define a UI with a number of widgets that implement {@link Filter}
 * . These must be added to the list of filters in the subclass constructor.
 * 
 * @author will
 * 
 */
public abstract class BaseCompositeFilter extends Composite implements
    FilterContainer {
